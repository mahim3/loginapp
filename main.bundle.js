...
module.exports = "<div class=\"container\">\n  <p>\n    admin works!\n  </p>\n  <button (click)=\"getlogin()\">check login</button>\n  <button (click)=\"logoutUser()\">Logout</button>\n\n</div>"
...
var AdminComponent = (function () {
    ...
    AdminComponent.prototype.getlogin = function () {
        this.auth.getlogin();
    };
        ...
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* RouterModule */].forRoot([
                    ...
                    {
                        path: 'admin', canActivate: [__WEBPACK_IMPORTED_MODULE_10__auth_guard__["a" /* AuthGuard */]], component: __WEBPACK_IMPORTED_MODULE_6__admin_admin_component__["a" /* AdminComponent */],
                    },
                ])
            ],
            providers: [__WEBPACK_IMPORTED_MODULE_8__auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_10__auth_guard__["a" /* AuthGuard */]],
...
var AuthService = (function () {
    ...
    AuthService.prototype.getlogin = function () {
        var _this = this;
        this.http.post('http://localhost:5000/login', {}).subscribe(function (data) {
    ...
    AuthService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __param(0, Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["z" /* Inject */])(__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */])),
...
module.exports = "<div class=\"container\">\n  <form class=\"form-horizontal\" (submit)='loginUser($event)'>\n    <input type=\"text\" placeholder=\"username\" id='username'>\n    <input type=\"password\" placeholder=\"Password\" id='password'>\n    <input type=\"submit\" value=\"submit\">\n  </form>\n  <br> username = admin\n  <br> password = admin\n</div>"
